    ...
    for (DirectionsRoute route : routes) {
      modifiedRoutes.add(route.toBuilder().routeOptions(
        RouteOptions.builder()
          ...
          .waypointIndices(MapboxDirections.parseToIntegers(mapboxDirections.waypointIndices()))
          .waypointNames(MapboxDirections.parseToStrings(mapboxDirections.waypointNames()))
          .waypointTargets(MapboxDirections.parseToPoints(mapboxDirections.waypointTargets()))
          .continueStraight(mapboxDirections.continueStraight())
          .annotations(mapboxDirections.annotation())
          .approaches(MapboxDirections.parseToStrings(mapboxDirections.approaches()))
          .bearings(MapboxDirections.parseToListOfListOfDoubles(mapboxDirections.bearing()))
          .alternatives(mapboxDirections.alternatives())
          .language(mapboxDirections.language())
          .radiuses(MapboxDirections.parseToDoubles(mapboxDirections.radius()))
          ...
          .originTrace(MapboxDirections.parseToPoints(mapboxDirections.originTrace()))
          .originTraceRadiuses(MapboxDirections.parseToIntegers(mapboxDirections.originTraceRadiuses()))
          .originTraceTimestamps(MapboxDirections.parseToLongs(mapboxDirections.originTraceTimestamps()))
          .build()
      ).build());
    }
